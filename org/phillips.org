...
#+begin_answer
  ...
  largo de todo el periodo en los gráficos de la inflación, =inf=, la
  ...
  casos de la primera diferencia de la inflación, =d_inf=, y del paro
  cíclico, =paroc=.
#+end_answer
...
- Atendiendo a los resultados obtenidos con los contrastes de raíces
  ...
  #+begin_answer
    ...
    la regresión. En esas condiciones, es muy probable que los
    resultados de la estimación sean espurios y no reflejen una
    relación genuina entre las variables.
  #+end_answer
...
- Obtenga los errores típicos robustos a heteroscedasticidad y
  ...
  #+begin_answer
    El valor del BIC se minimiza cuando solo se incluye 1 retardo en
    el modelo.
...
- Con los resultados de la regresión anterior, contraste al $5\%$ la
  ...
  #+begin_answer
    ...
    0.13$. El estadístico $t$ resultante es $0.66$, por lo que no se
    rechaza al 5% la hipótesis de que el multiplicador de largo plazo
    es igual a 0 (valor $p = 0.51$).
...
#  LocalWords:  Hodrick Prescott Fuller Dickey BIC
