...
que el valor crítico de $-3.43$ para un nivel de significación del
$5\%$. En consecuencia, se rechaza la hipótesis nula de raíz unitaria
...
3. /Contraste la significación conjunta de las variables
   ...
   parámetros de las variables estacionales sean iguales a 0 aun nivel
   de significación del $5\%$. Por tanto, estas variables ficticias
   capturan las variaciones estacionales presentes en las variables
...
5. /De acuerdo con nuestros objetivos, las variable más importantes
   son $\beltlaw$ y $\speedlaw$. Interprete y determine la
   significación individual de sus parámetros. ¿Cómo pueden explicarse
   ...
   los conductores adoptan conductas más arriesgadas si perciben que
   están más protegidos en caso de accidente. En ese caso, la
...
6. /¿Es razonable el supuesto de exogeneidad estricta de las
   ...
   retardos de la variable dependiente, y no parece imprescindible
...
- La distribución bajo la hipótesis nula es difícil de obtener y
  ...
  que impiden decidir con certeza si se debe rechazar o no la
  hipótesis nula.
