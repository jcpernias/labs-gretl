...
\ifbool{answers}{%
  \newtcolorbox{answer}{coltext=Black!70, colframe=SlateGray!70!Black,%
    colback=LightSteelBlue!5!White, notitle, boxrule=0.5pt,%
...
\usepackage{fbox}
\usepackage{fancyvrb}
%\fvset{fontsize=\footnotesize,frame=lines,framerule=0.4pt}
\newcommand{\gretl}[2][]{%
  \begin{center}%
    \vspace*{1.5ex}
    \fbox*[tb]{\BVerbatimInput[%
